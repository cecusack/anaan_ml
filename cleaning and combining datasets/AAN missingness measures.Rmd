...
- BDI: 
  ...
  - clinical (21 item): pt, r15, RPS, CS. item 7 was removed from PT and R15 and item 9 was removed from RPS and CS (suicidal ideation). rescored items 16 and 18   
...
# data 1 = DH3
data1_import <- read.csv("/Users/clairecusack/Dropbox/Research/Coauthor/anaan_ml raw dat/dh3_merged.csv")
data1 <- data1_import
...
dim(data1) # 147 x 377
# data 2 = PT
data2_import <- read.csv("/Users/clairecusack/Dropbox/Research/Coauthor/anaan_ml raw dat/PT_CLEANED_data.csv")
data2 <- data2_import
...
dim(data2) # 75 x 1891
# data 3 = online IE
data3_import <- read.csv("/Users/clairecusack/Dropbox/Research/Coauthor/anaan_ml raw dat/OIE2.csv")
data3 <- data3_import
...
dim(data3) # 229 x 943
# data 4 = V
data4_import <- read.csv("/Users/clairecusack/Dropbox/Research/Coauthor/anaan_ml raw dat/IIE2.csv")
data4 <- data4_import
...
dim(data4) # 37 x 1137
# data 5 = R15 PR
data5_import <- read.csv("/Users/clairecusack/Dropbox/Research/Coauthor/anaan_ml raw dat/R15CLEANED_data.csv")
data5 <- data5_import
...
dim(data5) # 99 x 689
# data 6 = R34 RPS
data6_import <- read.csv("/Users/clairecusack/Dropbox/Research/Coauthor/anaan_ml raw dat/R34CLEANED_data.csv")
data6 <- data6_import
...
dim(data6) # 99 x 2053
# data 7 = CS
data7_import <- read.csv("/Users/clairecusack/Dropbox/Research/Coauthor/anaan_ml raw dat/CS_CLEANED_data.csv")
data7 <- data7_import
...
# dx again
```{r results='hide'}
old <- read_csv("/Users/clairecusack/Dropbox/Research/Coauthor/anaan_ml/cleaning and combining datasets/archived/ANAANcombined_cec_2023-06-29.csv")
...
# cronbach's alpha
```{r}
dat <- read.csv("ANAANcombined_cec_2023-07-19.csv")
```
